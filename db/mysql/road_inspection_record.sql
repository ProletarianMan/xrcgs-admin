...
CREATE TABLE `road_inspection_record` (
  ...
  `form_payload_json` LONGTEXT COMMENT '原始提交payload',
  `details_payload_json` LONGTEXT COMMENT 'details原始payload',
  `summary_payload_json` LONGTEXT COMMENT 'summary标准化快照',
